 ...
 * Logic extracted from the original PQClean PQCLEAN_FALCONPADDED1024_AVX2_crypto_sign_keypair
 * function.
...
/* see api.h */
int
PQCLEAN_FALCONPADDED1024_AVX2_crypto_sign_keypair_from_seed(
    uint8_t *pk, uint8_t *sk, const uint8_t *seed, size_t seed_len) {
