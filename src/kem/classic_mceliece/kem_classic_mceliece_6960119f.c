...
extern int PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t seed[32]);
...
extern int PQCLEAN_MCELIECE6960119F_AVX2_crypto_kem_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t seed[32]);
